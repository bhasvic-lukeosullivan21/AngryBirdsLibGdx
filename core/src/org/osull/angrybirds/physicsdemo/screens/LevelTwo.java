...
//        for (int i=0; i<10; i++) {
//            MusicalNote musicalNote = new MusicalNote(world,10, 4+(i*4));
//            stage.addActor(musicalNote);
//            //spawns in a tower of musical note boxes
//        }
        Plank plank1 = new Plank(world, "wood.jpg", 1.2f, 10, 40, 10);
        stage.addActor(plank1);
        Plank plank2 = new Plank(world, "wood.jpg",1.2f, 10, 40+10, 10);
